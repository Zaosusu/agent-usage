...
| commit `50c8d23` | 150 万 | ❌ 源自错误的 113.6 万区间 |
| commit `5e48aea` | 120 万 | ❌ 继承 113.6 万的错误区间（113.6~139.0 万） |
| commit `463818f` | 230 万 | ❌ IndexedDB 时间窗硬锚点，窗口漂 40 倍 + 编造「同额度池」 |
| 重建法 v1 | 47.8 万 | ⚠️ 只算消息体，漏掉上下文重发（方向对、偏低） |
| 重建法 v2 | 113.6 万 | ❌ **重复计算**（见下方陷阱） |
| **消息级对齐（现行）** | **50 万** | ✅ 双向匹配率 90%/95.2%，两口径夹逼 |
